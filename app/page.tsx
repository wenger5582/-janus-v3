...
function sacarCadena(item: any) {
  ...
  if (todo.includes('washingtonpost') || todo.includes('washington post')) return 'WP'
  ...
  if (todo.includes('elpais') || todo.includes('el pais')) return 'EL PAIS'
  ...
  // Si viene de Google News, intenta sacar la cadena real del título
  ...
  if (host) {
    ...
    if (['news','com','net','org','co'].includes(limpio)) return 'OTROS'
